...
class CSdk
{
    ...
    struct RechargeData
    {
        ...
        CMyString       signCgi;        // 打签调用的CGI     (支付中心提供)
        CMyString       verifyCgi;      // 消费调用的CGI     (支付中心提供)
    };
    struct WithdarwData
    {
...
public:
    ...
    CMyString& getSignCgi(void) { return m_recharge.signCgi; }
    CMyString& getVerifyCgi(void) { return m_recharge.verifyCgi; }
